   ...
   function city()
    {
        ...
        var city1 = ["Rajasthan" , "Bihar", "Madhya Pradesh", "Uttar Pradesh", "Karnataka","Chattisgarh","Jharkand","maharasthra","punjab","goa","gujarat"]
                    $("#loca").autocomplete({
                    source: city1
                    });
        ...
        <div class="col-sm-5 col-sm-offset-5">
         ...
         <p style="padding:40px"></p>
                ...
                <div class="col-xs-12 col-sm-2">
                    ...
                    <input type="text" id="tags"   placeholder="City" class="box" onkeyup="city()">
                    
                </div>
                  
               
                <div class="col-xs-12 col-sm-2">
                <input type="text" id="loca"   placeholder="Location" class="box" onkeyup="city()">
                </div>
                <div class="col-xs-12 col-sm-5 col-offset-1" >
                <input type="text" id="autocomp"  placeholder="Specilization,Doctor,Hospital,Clinic" class="bigbox uisearch" onkeyup="Ser(this.value)">
                </div>
                <div class="col-xs-12 col-sm-2">
                <input type="button"  id="b"  value="Search" class="box"  >
                </div>
							...
							<div class="login-grids">
									<div class="login-bottom">
										...
										<form action="#" method="post">
                                            ...
                                            <div class="sign-up">
												<h4>Gender :</h4>
												<input type="radio" id="male"> Male &nbsp; <input type="radio" id="female"> Female &nbsp;<br><br>
											</div>
                                             <div class="sign-up">
												<h4>Date  Of Birth:</h4>
												<input type="Date" name="date" value="date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'date';}" required=""><br><br>	
											</div>
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
							<div class="login-grids">
									...
									<div class="login-right">
										<h3>Sign in with your account</h3>
										<form action="list_of_patient.html" >
											<div class="sign-in">
												<h4>Email :</h4>
												<input type="text" name="Type here" value="Type here" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Type here';}" required="">	
											</div>
							...
							<div class="login-grids">
									<div class="login-bottom">
										...
										<form action="#" method="post">
                                            ...
                                            <div class="sign-up">
                                                <h4> Specilization :</h4>
                                                <input type="text" name="Specilization" value="Specilization" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Specilization';}" required="">
                                            
                                            </div>
                                            <div class="sign-up">
												<h4>Degree :</h4>
												<input type="text" name="Degree" value="Type here" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Degree';}" required="">	
											</div>
                                            <div class="sign-up">
												<h4>Experiance :</h4>
												<input type="text" name="Experiance" value="Type here" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Experiance';}" required="">	
											</div>
                                            <div class="sign-up">
												<h4>Password :</h4>
												<input type="password" name="Password" value="Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" required="">
