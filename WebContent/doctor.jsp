        ...
        <div class="container">
            <div class="header_right">
                ...
                <ul> 
                    ...
                    <li><a href="#"><span aria-hidden="true"><img src="icon/user.png" width="30px" height="40px"></span>       <% Doctor doc = (Doctor) session.getAttribute("currentSessionDoctor");%>
			
            Welcome <%= doc.getName() + " "  %></a></li>
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--horatio">
						<ul class="nav navbar-nav menu__list">
							<li class="menu__item menu__item--current"><a href="doctor.jsp" class="menu__link">Patient_List</a></li>
						
							<li class="menu__item"><a href="blog.html" class="menu__link">Blogs</a></li>
                            <li class="menu__item"><a href="doctor_details.html" class="menu__link">My Details</a></li> 
						</ul>
					</nav>
				</div>
			</nav>
