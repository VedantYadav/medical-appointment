...
<body>
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--horatio">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item  menu__item--current"><a href="patientappointment.html" class="menu__link">My Appointmnet</a></li> 
							
							<li class="menu__item"><a href="medicalhistory.jsp" class="menu__link">Medical History</a></li> 
    ...
    <c:forEach items="${appointments}" var="appointment">
        <tr>
            ...
            <td><c:out value="${appointment.st_time}" /></td>
