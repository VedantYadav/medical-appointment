				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--horatio">
						<ul class="nav navbar-nav menu__list">
							<li class="menu__item menu__item--current"><a href="patient.jsp" class="menu__link">Book</a></li>
							<li class="menu__item"><a href="PatientAppointmentServlet" class="menu__link">My Appointmnet</a></li> 
							
							<li class="menu__item"><a href="MedicalHistoryServlet" class="menu__link">Medical History</a></li> 
							<li class="menu__item"><a href="mydetails.html" class="menu__link">My Details</a></li>
    ...
    <div class="Container">
      ...
      <h3 text-align:center>Book An Appointment</h3>
        ...
        <p style="padding:80px";></p>
                ...
                <input type="text" id="autocomp"  placeholder="Search" class="bigbox uisearch" onkeyup="Ser(this.value)">
                </div>
                <div class="col-xs-12 col-sm-2">
                 <input type="button" id="b"  placeholder="Search" value="Search" class="box">
                </div>
